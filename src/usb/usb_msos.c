...
} STRUCT_PACKED msos_compat_func;
                                    ...
                                    uint32_t value)
{
    ...
    prop->dwPropertyDataType = (MSOS_REG_DWORD_LE);
    length += usb_desc_msos_prop_name(prop, name);
    data = (void *)(dest + length);

    data->dwPropertyDataLength = (4);
