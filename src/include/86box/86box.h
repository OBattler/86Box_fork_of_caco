...
/* Function prototypes. */
#ifdef HAVE_STDARG_H
extern void pclog_ex(const char *fmt, va_list) __attribute__ ((format (printf, 1, 2)));
extern void fatal_ex(const char *fmt, va_list) __attribute__ ((format (printf, 1, 2)));
#endif
